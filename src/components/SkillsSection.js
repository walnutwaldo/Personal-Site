...
class SkillsSection extends React.Component {
  ...
  render() {
    ...
    return (
      <section name="skills" id="skills" className="pt-md-3 my-5">
          ...
          return (
            <Row className="skill mt-5" key={i}>
              ...
              >
                ...
                <p className={"pe-2"}>{skill.description}</p>
              ...
              <Col
                className={
                  "col-12 col-md-7 col-lg-6 order-1 order-md-2 mt-0 my-md-auto" +
                  (i % 2 === 0 ? "" : " order-lg-1")
                }
              >
                <InteractiveImage src={urls[skill.title]} />
              </Col>
              <Col className="d-none d-md-block d-lg-none order-3 pt-4">
                {notableWork}
              </Col>
            </Row>
          );
